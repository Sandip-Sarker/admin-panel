                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="index.html">
                            <img src="{{asset('backend')}}/assets/images/brand/softy_white.png" class="header-brand-img desktop-logo" alt="logo">
                            ...
                            <img src="{{asset('backend')}}/assets/images/brand/softvence.png" class="header-brand-img light-logo1" alt="logo" style="height: 6rem; width: 15rem; margin-top: -30px;">
                        </a><!-- LOGO -->
                    </div>
